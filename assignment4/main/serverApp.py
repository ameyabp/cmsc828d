...
def getMap():
    if request.method == 'POST':
        ...
        if choice == 'instances':
        	...
        	cursorMap.execute(f'select stateFips, sum({choice}) as value from storms where state is not null and year between {beginYear} and {endYear} group by stateFips;')
