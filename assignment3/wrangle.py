...
if __name__ == '__main__':
    ...
    newFrame = {'eventID':eventID, 'eventType':eventType, 'state':state, 'stateFips':stateFip, 'czmType':czmType, 'countyFips':countyFips, 'lat':lat, 'lng':lng, 'beginDate':beginDate, 'endDate':endDate, 'injuries':injuries, 'deaths':deaths, 'damage':damage}
