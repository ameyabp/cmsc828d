...
if __name__ == '__main__':
	...
	countyName = compositeFrame[colName2colIndexDict[15]]
	...
	newFrame = {'eventID':eventID, 'eventType':eventType, 'state':state, 'stateFips':stateFip, 'czmType':czmType, 'countyFips':countyFips, 'countyName':countyName, 'lat':lat, 'lng':lng, 'beginDate':beginDate, 'endDate':endDate, 'injuries':injuries, 'deaths':deaths, 'damage':damage}
